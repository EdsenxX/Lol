...
<html lang="es">
	...
	<body>
			...
			<div class="ancho">
				...
				<nav>
					<ul>
						...
						<li><a href="regi.php"><span class="fa fa-user"></span>Usuarios</a></li>
		...
		<div class="container">
			<div class="row">
				<h2 style="text-align:center">Consulta De Usuarios</h2>
			</div>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="modificarus.php?id=<?php echo $row['id']; ?>" style="color: #337ab7;"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="eliminarus.php?id=<?php echo $row['id']; ?>" style="color: #337ab7;"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
